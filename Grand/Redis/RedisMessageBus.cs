...
namespace Grand.Infrastructure.Caching.Redis
{
    public class RedisMessageBus : IMessageBus
    {
        ...
        public RedisMessageBus(ISubscriber subscriber, IServiceProvider serviceProvider)
        {
            _subscriber = subscriber;
            _serviceProvider = serviceProvider;
            //TODO:Ensure this FireAndForget is OK?!
            SubscribeAsync();
        }
        ...
        public virtual Task SubscribeAsync()
        {
            ...
            //TODO:Ensure this FireAndForget is OK?!
            sub.SubscribeAsync("channel", async (_, redisValue) =>
            {
                try
                {
